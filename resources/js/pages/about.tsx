                ...
                <div className="grid auto-rows-min gap-4 md:grid-cols-3">
                    ...
                    <div className="relative overflow-hidden rounded-xl border border-sidebar-border/60 dark:border-sidebar-border">
                        ...
                        <div className="relative z-10 flex h-full flex-col items-center justify-center p-6">
                           ...
                           <h3 className="text-center tracking-tight font-bold text-lg text-sidebar-foreground mb-4"> 
                                ACC Official Seal
                           </h3>
                    ...
                    <div className="relative overflow-hidden rounded-xl border border-sidebar-border/60 dark:border-sidebar-border">
                        ...
                        className="mb-4 h- w-40 rounded-full object-cover md:h-44 md:w-44"/>
                    ...
                    <div className="relative overflow-hidden rounded-xl border border-sidebar-border/60 dark:border-sidebar-border">
                        ...
                        className="mmb-4 h-10 w-40 rounded-full object-cover md:h-48 md:w-48 p-1"/>
